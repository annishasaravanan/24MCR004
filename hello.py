...
filename = "E:\\24MCR004\\Iris.csv"  # <-- Full absolute path
...
data.hist()
pyplot.savefig("E:\\24MCR004\\histograms.png")
pyplot.close()

# Step 4: Plot and save density plots silently
data.plot(kind='density', subplots=True, layout=(3,3), sharex=False)
pyplot.savefig("E:\\24MCR004\\density_plots.png")
pyplot.close()
...
joblib.dump(model, "E:\\24MCR004\\logistic_model.pkl")

print("Model saved successfully at E:\\24MCR004\\logistic_model.pkl")
